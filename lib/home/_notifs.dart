...
class NotifsScreen extends StatefulWidget {
  ...
  const NotifsScreen({super.key, required this.scrollController});
...
class _NotifsScreenState extends State<NotifsScreen> {
  ...
  Widget build(BuildContext context) {
    return TweetContextScope(
      child: ScopedBuilder<NotifsModel, List<Object>>.transition(
        store: _model,
          ...
          child: items.isEmpty
              ? ListView(children: [
                  Padding(
                    ...
                    child: Center(
                      child: Text(L10n.of(context).no_notifications_yet, style: Theme.of(context).textTheme.bodyLarge),
                    ),
                  ),
                ])
